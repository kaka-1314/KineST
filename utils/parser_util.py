...
def parse_and_load_from_model_eval(parser,modelpath):
    # args according to the loaded model
    # do not try to specify them from cmd line since they will be overwritten
    add_data_options(parser)
    add_model_options(parser)
...
def add_data_options(parser):
    ...
    group.add_argument(
        ...
        #default='/media/d/data/CVPR_2023_2/data_fps60e/',
        type=str,
        help="Dataset path",
    )
...
def add_sampling_options_eval(parser, modelpath):
    ...
    group.add_argument(
        "--support_dir",
        default="./support_data/body_models",
        type=str,
...
def sample_args_eval(modelpath):
    parser = ArgumentParser()
    # parser.add_argument(
    #     "--model_path",
    #     default= modelpath,
    ...
    # args specified by the user: (all other will be loaded from the model)
    add_base_options(parser)
    add_sampling_options_eval(parser,modelpath)
    return parse_and_load_from_model_eval(parser, modelpath)
